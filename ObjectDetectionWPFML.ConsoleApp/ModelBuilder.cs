...
namespace ObjectDetectionWPFML.ConsoleApp {
    public static class ModelBuilder {
        private static string TRAIN_DATA_FILEPATH = @"D:\Projects_VS\ML.NET project\Boiciuc Cosmin-Ionel (Arhitecturi consacrate pentru retele neurale adanci)\PneumoniaDetectionWPF\TrainData.tsv";
